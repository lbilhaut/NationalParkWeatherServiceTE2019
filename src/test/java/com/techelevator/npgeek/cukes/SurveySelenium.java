...
public class SurveySelenium {
	...
	public void elements_can_be_found_by_id() {
		WebElement savingsH2 = webDriver.findElement(By.id("survey"));
	}
...
//		List<WebElement> sections = webDriver.findElements(By.tagName("li"));
//		Assert.assertEquals(3, sections.size());
//		for(WebElement section : sections) {
//			Assert.assertEquals("survey", section.getAttribute("survey"));
//		}
//	}
////	
	@Test
	public void pages_can_be_navigated_by_clicking_on_links() {
		...
		WebElement calculatorLink = webDriver.findElement(By.linkText("Favorite Parks")); 
	}
